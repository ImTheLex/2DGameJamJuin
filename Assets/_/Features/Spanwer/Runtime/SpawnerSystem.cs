...
public class SpawnerSystem : MonoBehaviour
{
    ...
    private void PrepareWave()
    {
        ...
        //var interval = m_currentWaveConfig.m_spawnInterval - (m_currentWaveConfig.m_spawnIntervalReduction/m_currentWaveConfig.m_spawnIntervalWave);
        ...
        phantomTypesToSpawn.AddRange(Enumerable.Repeat(PhantomBehaviour.PhantomType.Easy, basicToSpawn));
        phantomTypesToSpawn.AddRange(Enumerable.Repeat(PhantomBehaviour.PhantomType.Medium, mediumToSpawn));
        phantomTypesToSpawn.AddRange(Enumerable.Repeat(PhantomBehaviour.PhantomType.Hard, hardToSpawn));
